...
do
  ...
  # Enabling All APIs
  gcloud services enable cloudresourcemanager.googleapis.com serviceusage.googleapis.com logging.googleapis.com appengine.googleapis.com
  # CReating App Engine
...
do
    ...
    gcloud projects add-iam-policy-binding $i --member="serviceAccount:${sa}" --role='roles/cloudsql.client'
done
